        ...
        <div class="router-view">
          <div class="router-content">
               ...
               <div
                ...
                <vs-dropdown vs-trigger-click class="ml-auto md:block hidden cursor-pointer">
                  ...
                  <vs-dropdown-menu class="w-32">
                    <vs-dropdown-item>
                      <div @click="$router.push('/apps/user/user-view/owner').catch(() => {})" class="flex items-center">
                        <feather-icon icon="UserIcon" class="inline-block mr-2" svgClasses="w-4 h-4" />
                        <span>个人信息</span>
                      </div>
                    </vs-dropdown-item>
                    <vs-dropdown-item>
                      <div @click="$router.push('/apps/clockin').catch(() => {})" class="flex items-center">
                        <feather-icon icon="CheckSquareIcon" class="inline-block mr-2" svgClasses="w-4 h-4" />
                        <span>打卡</span>
                      </div>
                    </vs-dropdown-item>
                    <vs-dropdown-item>
                      <div @click="$router.push('/apps/calendar/vue-simple-calendar').catch(() => {})" class="flex items-center">
            ...
            <div class="content-area__content">
              ...
              <back-to-top bottom="5%" :right="$vs.rtl ? 'calc(100% - 2.2rem - 38px)' : '30px'" visibleoffset="10" v-if="!hideScrollToTop">
